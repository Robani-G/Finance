...
<!-- Mirrored from admin.pixelstrap.net/riho/template/letter-box.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Sep 2024 20:37:47 GMT -->
<head>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown notification-down">
                <div class="notification-box">
                  <svg>
                    <use href="  #notification-header"></use>
          ...
          <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-widget"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-widget"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-layout"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-layout"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-project"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-project"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="file-manager.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-file"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-file"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="kanban.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-board"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-board"></use>
                    </svg><span>kanban Board</span></a></li>
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-ecommerce"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-ecommerce"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="letter-box.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-email"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-email"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-chat"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-chat"></use>
                ...
                <li class="sidebar-list"> <i class="fa fa-thumb-tack"> </i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-user"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-user"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="bookmark.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-bookmark"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-bookmark"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="contacts.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-contact"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-contact"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="task.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-task"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-task"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-calendar"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-calender"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="social-app.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-social"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-social"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="to-do.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-to-do"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-to-do"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="search.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-search"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-search"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-form"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-form"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-table"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-table"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-ui-kits"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-ui-kits"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-bonus-kit"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-bonus-kit"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-animation"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-animation"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-icons"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-icons"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-button"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-botton"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-charts"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-charts"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="landing-page.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-landing-page"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-landing-page"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="sample-page.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-sample-page"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-sample-page"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="internationalization.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-internationalization"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-internationalization"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="https://admin.pixelstrap.net/riho/starter-kit/index.html" target="_blank">
                    <svg class="stroke-icon">
                      <use href="  #stroke-starter-kit"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-starter-kit"></use>
                ...
                <li class="mega-menu sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-others"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-others"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-gallery"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-gallery"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-blog"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-blog"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="faq.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-faq"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-faq"></use>
                    </svg><span>FAQ</span></a></li>
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-job-search"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-job-search"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-learning"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-learning"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-maps"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-maps"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="  #stroke-editors"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-editors"></use>
                ...
                <li class="sidebar-list"> <i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="knowledgebase.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-knowledgebase"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-knowledgebase"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="support-ticket.html">
                    <svg class="stroke-icon">
                      <use href="  #stroke-support-tickets"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="  #fill-support-tickets"></use>
